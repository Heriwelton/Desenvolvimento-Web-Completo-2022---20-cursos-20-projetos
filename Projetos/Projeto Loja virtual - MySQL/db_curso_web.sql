...
--
-- Host: 127.0.0.1
-- Tempo de geração: 06-Jan-2023 às 21:09
...
INSERT INTO `tb_cursos` (`id_cursos`, `imagem_curso`, `nome_curso`, `resumo`, `data_cadastro`, `ativo`, `investimento`, `carga_horaria`) VALUES
...
(5, 'linux.jpg', 'Introdução ao GNU/Linux', 'Resumo do curso de GNU/Linux', '2018-05-01 00:00:00', 0, 0, 1);
COMMIT;
